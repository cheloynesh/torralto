...
class ExportEmitNoPay implements FromCollection, WithHeadings
{
    /**
    ...
    */
    ...
    {
        $movimientos = DB::select('call exclEmitNoPay(?,?,?,?,?)',[$this->brnch,$this->insrnc,$this->mnth,$this->quart,$this->year]);
